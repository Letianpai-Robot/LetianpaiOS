...
public class Player {
    ...
    private List<MessageMusicBean> musics;

    private MediaPlayer mPlayer;

    private MessageMusicBean currentMusic;
    ...
    public void init(List<MessageMusicBean> musics) {
        this.musics = musics;
        mSize = musics.size();
...
//            mPlayer.reset();
    ...
    public MessageMusicBean getCurrentMusic() {
        return currentMusic;
    }
    ...
    private void setAndPrepared() {
        try {
            Log.i(TAG, "Player setAndPrepared: " + currentMusic);
            mPlayer.reset();
    ...
    public List<MessageMusicBean> getMusicList() {
        return musics;
    }

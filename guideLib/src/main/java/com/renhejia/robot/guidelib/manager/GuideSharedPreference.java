 ...
 * @author liujunbin
 */
public class GuideSharedPreference {
    ...
    public static final String SHARE_PREFERENCE_NAME = "RobotConfig";
    ...
    public GuideSharedPreference(Context context, String fileName, String action) {
